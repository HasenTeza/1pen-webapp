...
Page({
  ...
  onLoad: function (options) {
    ...
    //获取一级分类信息
    wx.request({
      url: app.globalData.requestUrl + '/index/category/getFirstCatInfo',
      data: { bis_id: bis_id },
      header: {
        'content-type': ''
      },
      success: function (res) {
        //获取初始二级分类信息
        wx.request({
          url: app.globalData.requestUrl + '/index/category/getSecondCarInfoById',
          ...
          //获取商品信息
          wx.request({
            url: app.globalData.requestUrl + '/index/category/getProInfoByFirstId',
            data: { cat_id: res.data.result[0]['cat_id'] },
            header: {
              'content-type': ''
            },
  ...
  getProDetail: function (event) {
    ...
    wx.navigateTo({
      url: '../pro_detail/pro_detail?pro_id=' + pro_id,
    })
  },
  //通过二级分类id获取商品信息
  getProBySecondId: function (e) {
    ...
    wx.request({
      url: app.globalData.requestUrl + '/index/category/getProInfoBySecondId',
      data: postdata,
      header: {
        'content-type': ''
      },
  ...
  loadMore: function (e) {
    ...
    page++
    if (cat2_id == 0) {
      var url = app.globalData.requestUrl + '/index/category/getProInfoByFirstId'
      var postData = {
        cat_id: cat1_id,
        page: page
      }
    } else {
      var url = app.globalData.requestUrl + '/index/category/getProInfoBySecondId'
      var postData = {
        cat_id: cat1_id,
        cat2_id: cat2_id,
        page: page
